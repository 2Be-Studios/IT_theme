...
<body <?php body_class();?>>
	<header class="home-nav__wrapper connect-nav__wrapper">
		<nav class="home-nav clear">
			<div class="float-left clear">
				<a href="<?php echo get_home_url();?>" class="logo-wrapper dp-flex">
					<div class="img-wrapper">
						<img src="<?php echo get_template_directory_uri();?>/assets/images/insight-logo-white.png" alt="" class="logo">
					</div>
					<p>Connect</p>
				</a>
